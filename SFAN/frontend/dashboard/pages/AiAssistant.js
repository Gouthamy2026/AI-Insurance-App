        ...
        <section class="module-section active" style="max-width: 1000px; margin: 0 auto; padding: 40px; min-height: calc(100vh - 80px); box-sizing: border-box; animation: fadeIn 0.4s ease; background: transparent;">
            ...
            <div class="ai-container">
                ...
                <div class="ai-greeting">
                    <div>
                        <h2>Hey, <span style="color: #3B82F6;">Good Morning! 👋</span></h2>
                ...
                <div class="ai-suggestions">
                    ${[
                        ...
                        {icon: '<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>', text: 'What is No Claim Bonus (NCB)?'},
                ...
                <div class="ai-input-container">
                    <input type="text" class="ai-input" placeholder="Type your question here...">
