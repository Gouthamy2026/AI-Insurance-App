export const Sidebar = (activeModule, setActiveModule) => {
    ...
    const navSections = [
        ...
        },
        {
            ...
            items: [
                { id: 'insurance-goals', label: 'Personal Insurance Goals', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>' },
